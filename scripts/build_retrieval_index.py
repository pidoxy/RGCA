...
from rgca_baseline.embeddings import HashingTextEmbedder, MockImageEmbedder
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--backend",
        default="mock_image",
        choices=["mock_image", "hashing_text"],
...
def main() -> None:
    ...
    embedder = MockImageEmbedder() if args.backend == "mock_image" else HashingTextEmbedder()
